...
1. **Define intent:** What's the problem? What's the value? What are the constraints?
2. **Design guardrails:** What's off-limits? What must always be true? What's the interface?
3. **Activate autonomy:** Let the GAIA execute in that space
4. **Review outcomes:** Iterate on intent or guardrails based on what's generated
